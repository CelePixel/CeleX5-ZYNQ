...
public:
	...
	DataReaderThread(CeleX5* pSensor, const std::string& name = "DataReaderThread");
    ~DataReaderThread();
...
class MIPIDataReaderThread : public XThread
{
public:
	MIPIDataReaderThread(CeleX5* pSensor, const std::string& name = "DataReaderThread");

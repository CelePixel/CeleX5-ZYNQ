...
#define  SERVER_IP      "192.168.1.11" //192.168.1.11  192.168.8.37
...
int CeleXTcpSocket::connectToZYNQServer()
{
	...
	servAddr.sin_addr.s_addr = inet_addr(SERVER_IP); //server ip: 192.168.1.11

...
public:
	...
	//inline unsigned char* getOpticalFlowSpeedPicBuffer() { return m_pOpticalFlowSpeedPic; }
	//inline unsigned char* getOpticalFlowDirectionPicBuffer() { return m_pOpticalFlowDirectionPic; }
